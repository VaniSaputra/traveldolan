                    ...
                    <div class="container">
                        <div class="row margin-vert-30">
                            ...
                            <div class="col-md-6 col-md-offset-3 col-sm-offset-3">
                                ...
                                <form name="form" class="login-page" method="post" action="login.php">
                                ...
                                if($submit){
                                        $cari = "select * from user where username='$username' and password='$password'";
                                        $queri= mysql_query($cari);
                                        $result = mysql_fetch_array($queri);
                                        if($result !=""){
                                            //berhasil login
                                            echo "$username";
                                            session_start();
