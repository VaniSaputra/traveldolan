                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portfolio-filter-container margin-top-20">
                                <ul class="portfolio-filter">
                                    ...
                                    <li>
                                        <a href="#" class="btn btn-default" data-filter=".Candi">Candi</a>
                                    </li>
                                    <li>
                                        <a href="#" class="btn btn-default" data-filter=".Goa">Goa</a>
                                    </li>
                                    <li>
                                        <a href="#" class="btn btn-default" data-filter=".Gunung">Gunung</a>
                                    </li>
                                    <li>
                                        <a href="#" class="btn btn-default" data-filter=".Pantai">Pantai</a>
                                    </li>
                                </ul>
                            </div>
                            <!-- End Filter Buttons -->
                    ...
                    <div class="row">
                        <div class="col-md-12 portfolio-group no-padding">
                            ...
                            <?php
                                ...
                                $cari = "SELECT * FROM `tujuan` where jenis_pemesanan = 'mandiri'";
